...
const menuSuggestionFlow = ai.defineFlow(
  ...
  async (subject, { sendChunk }) => {
    ...
    // it to a string, but more complicated flows might coerce the response
    // into structured output or chain the response into another LLM call, etc.
...
export const menuSuggestion = onCallGenkit(
  {
    ...
    // helpers can be used to simplify. The following will require the user
    // to have the email_verified claim, for example.
